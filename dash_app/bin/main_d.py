...
app.layout = dbc.Container([
    ...
    dcc.Tabs([
        dcc.Tab(label='Finder', children=[  # Everything will be inside this tab
        ...
        dcc.Tab(label='Chatbot', children=[  # Separate tab for About page
            html.Div("Chatbot content here")
        ]),
        dcc.Tab(label='Analysis', children=[  # Separate tab for About page
            html.Div("Analysis content here")
        ]),
        dcc.Tab(label='About', children=[  # Separate tab for About page
